...
<head>
    ...
    <script>
        function validateForm() {
            ...
            if (eventType === "" || locationId === "" || severityLevel === "" || alertMessage === "") {
        ...
        <div class="col-span-9 pt-2 w-[80%]">
            ...
            <form action="#" method="POST" class="mt-4">
                <div class="mt-4">
                    ...
                    <select id="event_type" name="event_type" required class="p-1.5 block w-full border-2 rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50">
                ...
                <div class="mt-4">
                    ...
                    <select id="location_id" name="location_id" required class="p-1.5 block w-full border-2 rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50">
                ...
                <div class="mt-4">
                    ...
                    <input type="range" id="severity_level" name="severity_level" min="0" max="10" step="1" value="5" class="slider w-full">
                </div>
                <div class="mt-4">
                    <label for="alert_message" class="block text-sm font-medium leading-6 text-gray-900">Alert Message</label>
                    <textarea id="alert_message" name="alert_message" rows="4" required class="p-1.5 border-2 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50"></textarea>
                </div>
                <button type="submit" name="set_alert" class="mt-4 bg-indigo-600 text-white py-2 px-4 rounded">Set Alert</button>
            </form>
        </div>
    </div>
</body>
